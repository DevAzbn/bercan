...
$(".b-all-product-catalog").each(function(t){var e=$(this),i=e.find(".left-cont.category-list .category-list");i.find(".item > .link").on("click",function(t){var e=$(this);e.next(".children").size()>0&&(t.preventDefault(),e.closest(".item").toggleClass("active"))}).eq(0).trigger("click")});
...
$(".modal-after-send-faq").on("click",function(e){$(this);$("#modal-after-send-faq").trigger("setActive")});
$(".b-modal-container").each(function(t){var e=$(this),i=e.find(".modal-block").eq(0),o=e.find(".white-container").eq(0),n=e.find(".hide-modal");e.find(".item");e.on("setActive",function(t){e.css({height:$(document).height()+"px"}).addClass("active"),i.css({top:$(document).scrollTop()+50+"px"})}),e.on("setPassive",function(t){e.removeClass("active")}),e.on("click",function(t){t.preventDefault(),e.trigger("setPassive")}),n.on("click",function(t){t.preventDefault(),e.trigger("setPassive")}),o.on("click",function(t){t.stopPropagation()})}),$(".b-modal-container .item").on("setActive",function(t){$(this).addClass("active"),$(this).closest(".b-modal-container").trigger("setActive")}),$(".b-modal-container .item").on("setPassive",function(t){$(this).removeClass("active").closest(".b-modal-container").trigger("setPassive")}),$(".b-modal-btn").on("click",function(t){t.preventDefault(),t.stopPropagation(),console.log(".b-modal-btn click");var e=$(this),i=e.attr("href"),o=$(".b-modal-container .item").filter(i);o.size()>0?o.trigger("setActive"):o.trigger("setPassive")}),$(".b-modal-hide-btn").on("click",function(t){t.stopPropagation(),$(this).closest(".b-modal-container").find(".item.active").trigger("setPassive")}),$(".b-modal-fastlook").on("click",function(t){t.preventDefault(),t.stopPropagation(),console.log(".b-modal-fastlook click");var e=$(this),i=e.attr("data-product_id"),o=$(".b-modal-container .item#modal-fastlook-"+i);o.size()>0?o.trigger("setActive"):o.trigger("setPassive")});
...
$(".b-product-content").each(function(t){var a=$(this);a.find(".photos .other-photos .item").on("click",function(t){t.preventDefault();var a=$(this),o=a.find("img").attr("src");a.closest(".photos").find(".main-photo img").attr("src",o)}),a.find(".main-info .header ul li a").on("click",function(t){t.preventDefault();var a=$(this);$(".main-info .header ul li").removeClass("active"),a.parent().addClass("active"),$(".main-info .info-block").removeClass("active").filter(a.attr("href")).addClass("active")}).eq(0).trigger("click"),a.find(".order-info .btn-cont .like-btn").on("click",function(t){t.preventDefault();var a=$(this),o=a.attr("data-product_id");Shop.cart.like(o,function(t){}),a.toggleClass("active")}),a.find(".order-info .boxing a.item").on("click",function(t){t.preventDefault();var o=$(this),i=(o.closest(".boxing").attr("data-product_id"),o.attr("data-product_boxing")),n=o.attr("data-boxing_cost"),e=o.attr("data-boxing_oldcost");a.find(".order-info .cost-cont .real span").html(n),a.find(".order-info .cost-cont .old span").html(e),a.find(".order-info .cost-cont").attr("data-product_boxing",i),a.find(".order-info .boxing a.item").removeClass("active"),o.addClass("active")}).eq(0).trigger("click"),a.find(".order-info .taste a.item").on("click",function(t){t.preventDefault();var o=$(this),i=(o.closest(".taste").attr("data-product_id"),o.attr("data-product_taste"));a.find(".order-info .cost-cont").attr("data-product_taste",i),a.find(".order-info .taste a.item").removeClass("active"),o.addClass("active")}).eq(0).trigger("click"),a.find(".order-info .btn-cont .addone-to-cart").on("click",function(t){t.preventDefault();var o=$(this),i=parseInt(o.attr("data-product_id")),n=parseInt(a.find(".order-info .cost-cont").attr("data-product_boxing")),e=parseInt(a.find(".order-info .cost-cont").attr("data-product_taste"));Shop.cart.addone(i,n,e,function(t){o.html("В корзине").toggleClass("r2w w2r disabled"),setTimeout(function(){o.html("Купить").toggleClass("r2w w2r disabled")},2500)}),o.toggleClass("active")})});
...
$(".b-review-content").each(function(e){var i=$(this),n=i.find(".review-col"),t=i.find(".item_list");t.find(".item").each(function(e){var i=$(this),t=1e6,a=n.eq(0);n.each(function(e){var i=$(this);i.height()<t&&(t=i.height(),a=i)}),a.append(i)}),n.append($("<div/>",{"class":"clear"}))});
