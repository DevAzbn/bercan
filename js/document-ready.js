...
$(function(){var t=$(".b-top-cart"),a=t.find(".position"),n=$(".b-top-header .b-top-cart-counter");t.on("recalc-all-position",function(r){r.preventDefault();var e=0,o=0,i=0;a.each(function(t){var a=$(this),n=parseInt(a.attr("data-amount")),r=parseInt(a.attr("data-cost"));e+=n*r,o++,i+=n}),t.attr("data-sum",e),t.attr("data-iamount",o),t.attr("data-aamount",i),t.find(".sum-cont .sum span").html(e),n.html(o)}),t.trigger("recalc-all-position"),a.each(function(a){var n=$(this),r=n.find(".pos-counter"),e=r.find("a.d"),o=r.find("a.u"),i=r.find("span.c"),d=n.find(".sum span"),c=n.find(".delete a");n.on("add-one-item",function(a){a.preventDefault();var r=parseInt(n.attr("data-amount")),e=parseInt(n.attr("data-cost")),o=parseInt(n.attr("data-orderitem")),c=parseInt(n.attr("data-cost_id")),l=parseInt(n.attr("data-product_id"));r+=1,Shop.cart.set(l,c,o,r,function(a){n.attr("data-amount",r),i.html(n.attr("data-amount")),d.html(r*e),t.trigger("recalc-all-position")})}),n.on("delete-one-item",function(a){a.preventDefault();var r=parseInt(n.attr("data-amount")),e=parseInt(n.attr("data-cost")),o=parseInt(n.attr("data-orderitem")),c=parseInt(n.attr("data-cost_id")),l=parseInt(n.attr("data-product_id"));r-=1,0>r?(r=0,t.trigger("recalc-all-position")):Shop.cart.set(l,c,o,r,function(a){n.attr("data-amount",r),i.html(n.attr("data-amount")),d.html(r*e),t.trigger("recalc-all-position")})}),n.on("delete-all-items",function(a){a.preventDefault();var r=0,e=parseInt(n.attr("data-cost")),o=parseInt(n.attr("data-orderitem")),c=parseInt(n.attr("data-cost_id")),l=parseInt(n.attr("data-product_id"));Shop.cart.set(l,c,o,r,function(a){n.attr("data-amount",r),i.html(n.attr("data-amount")),d.html(r*e),t.trigger("recalc-all-position")})}),o.on("click",function(t){t.preventDefault(),n.trigger("add-one-item")}),e.on("click",function(t){t.preventDefault(),n.trigger("delete-one-item")}),c.on("click",function(t){t.preventDefault(),n.trigger("delete-all-items")})}),t.on("click",function(t){$(this)})});
