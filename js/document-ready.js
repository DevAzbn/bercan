...
$(".b-top-header").each(function(t){event.preventDefault();var e=$(this),a=e.find(".cart-btn"),i=e.find(".menu-btn");a.on("click",function(t){t.preventDefault();var e=$(this);i.hasClass("active")&&i.trigger("click"),e.toggleClass("active"),$(".b-top-cart").toggleClass("active")}),i.on("click",function(t){t.preventDefault();var e=$(this);a.hasClass("active")&&a.trigger("click"),e.toggleClass("active"),$(".b-drd-menu").toggleClass("active").height($(".b-top-menu").height())})});
$(".b-top-menu").each(function(e){event.preventDefault();var t=$(this),n=t.find(".search-btn"),c=t.find(".search-container .close-search");n.on("click",function(e){e.preventDefault();var t=$(this);t.closest(".menu-list").find(".search-container").toggleClass("active").find(".search-field input").trigger("focus")}),c.on("click",function(e){e.preventDefault();var t=$(this);t.closest(".search-container").toggleClass("active")})});
