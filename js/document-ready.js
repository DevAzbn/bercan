...
$(".b-modal-container").each(function(t){var e,i=$(this),o=i.find(".modal-block").eq(0),n=i.find(".white-container").eq(0),a=i.find(".modal-title .content").eq(0),c=i.find(".hide-modal");i.find(".item");i.on("setActive",function(t){i.css({height:$(document).height()+"px"}).addClass("active"),o.css({top:$(document).scrollTop()+50+"px"})}),i.on("setPassive",function(t){i.removeClass("active")}),i.on("click",function(t){c.trigger("click")}),c.on("click",function(t){i.trigger("setPassive")}),n.on("click",function(t){t.stopPropagation()}),$(document.body).on("setActive",".b-modal-container .item",function(t){e=$(".b-modal-container .item.active"),$(".b-modal-container .item").removeClass("active"),$(this).addClass("active"),a.html($(this).attr("data-title")),$(this).closest(".b-modal-container").trigger("setActive")}),$(document.body).on("setPassive",".b-modal-container .item",function(t){$(this).removeClass("active").closest(".b-modal-container").trigger("setPassive"),e.size()&&e.eq(0).trigger("setActive")}),$(document.body).on("click",".b-modal-btn",function(t){t.preventDefault(),t.stopPropagation();var e=$(this),i=e.attr("href"),o=$(".b-modal-container .item").filter(i);o.size()>0?o.trigger("setActive"):o.trigger("setPassive")}),$(".b-modal-hide-btn").on("click",function(t){t.stopPropagation(),$(".b-modal-container .item.active").trigger("setPassive")})});
...
$(".b-top-drd-menu").each(function(i){var t=$(this),n=t.find(".product-item"),e=n.find(".point-block"),a=n.find(".item-variant");e.find(".point").on("click",function(i){i.preventDefault(),i.stopPropagation();var t=$(this);a.hide(),a.eq(t.index()).fadeIn("fast"),e.find(".point").removeClass("active"),t.addClass("active")}).eq(0).trigger("click")});
