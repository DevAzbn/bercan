...
$(".b-modal-container").each(function(t){var i=$(this),e=i.find(".modal-block").eq(0),o=i.find(".white-container").eq(0),a=i.find(".hide-modal");i.find(".item");i.on("setActive",function(t){i.css({height:$(document).height()+"px"}).addClass("active"),e.css({top:$(document).scrollTop()+50+"px"})}),i.on("setPassive",function(t){i.removeClass("active")}),i.on("click",function(t){a.trigger("click")}),a.on("click",function(t){i.trigger("setPassive")}),o.on("click",function(t){t.stopPropagation()})}),$(".b-modal-container .item").on("setActive",function(t){lastactive=$(".b-modal-container .item.active"),$(this).addClass("active"),$(this).closest(".b-modal-container").trigger("setActive")}),$(".b-modal-container .item").on("setPassive",function(t){$(this).removeClass("active").closest(".b-modal-container").trigger("setPassive"),lastactive.size()&&lastactive.eq(0).trigger("setActive")}),$(".b-modal-btn").on("click",function(t){t.preventDefault(),t.stopPropagation(),console.log(".b-modal-btn click");var i=$(this),e=i.attr("href"),o=$(".b-modal-container .item").filter(e);o.size()>0?o.trigger("setActive"):o.trigger("setPassive")}),$(".b-modal-hide-btn").on("click",function(t){t.stopPropagation(),$(this).closest(".b-modal-container").find(".item.active").trigger("setPassive")}),$(".b-modal-fastlook").on("click",function(t){t.preventDefault(),t.stopPropagation(),console.log(".b-modal-fastlook click");var i=$(this),e=i.attr("data-product_id"),o=$(".b-modal-container .item#modal-fastlook-"+e);o.size()>0?o.trigger("setActive"):o.trigger("setPassive")});
