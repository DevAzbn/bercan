...
$(".b-top-drd-menu").each(function(i){var n=$(this),t=n.find(".product-item"),e=t.find(".point-block"),a=t.find(".item-variant");e.find(".point").on("click",function(i){i.preventDefault();var n=$(this);a.hide(),a.eq(n.index()).fadeIn("fast"),e.find(".point").removeClass("active"),n.addClass("active")}).eq(0).trigger("click")});
